...
#pragma mark - 圆角一直有效
    ...
    [imageView2 zy_cornerRadiusAdvance:60.0f rectCornerType:UIRectCornerAllCorners];
    imageView2.image = [UIImage imageNamed:@"mac_dog"];
    
    
    UIImageView *imageView3 = [[UIImageView alloc] initWithCornerRadiusAdvance:20.0f rectCornerType:UIRectCornerAllCorners];
    imageView3.image = [UIImage imageNamed:@"mac_dog"];
...
////    imageView.image = [UIImage imageNamed:@"mac_dog"];
    ...
    [imageView2 setFrame:CGRectMake(80, 250, 200, 200)];
